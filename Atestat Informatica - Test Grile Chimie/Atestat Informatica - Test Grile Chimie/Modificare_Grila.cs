    ...
    public partial class Modificare_Grila : MaterialForm
    {
        ...
        private void getCurrentQuestion()
        {
            try
            {
                ...
                sqlConnection.Open();
                string selectString = "SELECT * FROM Grile WHERE Intrebare = '" + Start_Profesor.instance.modifiedQuestion + "'";
        ...
        {
            MessageBox.Show(Start_Profesor.instance.modifiedQuestion);
            getCurrentQuestion();
        }
